...
public final class ListItemBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView imagePel;

  @NonNull
  public final TextView title;

  private ListItemBinding(@NonNull LinearLayout rootView, @NonNull ImageView imagePel,
      @NonNull TextView title) {
    this.rootView = rootView;
    this.imagePel = imagePel;
    this.title = title;
  }
  ...
  public static ListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.image_pel;
      ImageView imagePel = ViewBindings.findChildViewById(rootView, id);
      if (imagePel == null) {
        break missingId;
      }
      ...
      return new ListItemBinding((LinearLayout) rootView, imagePel, title);
    }
