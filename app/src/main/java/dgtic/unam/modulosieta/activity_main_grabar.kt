...
import dgtic.unam.modulosieta.databinding.ActivityMainGrabarBinding
import dgtic.unam.modulosieta.databinding.ActivityMainVideoBinding
import java.util.jar.Manifest

class activity_main_grabar : AppCompatActivity()
{
    private lateinit var binding : ActivityMainGrabarBinding
    ...
    override fun onCreate( savedInstanceState: Bundle? )
        {
            ...
            binding= ActivityMainGrabarBinding.inflate( layoutInflater )
            setContentView( binding.root )

            if( ContextCompat.checkSelfPermission(
                    this@activity_main_grabar,
